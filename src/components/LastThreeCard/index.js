...
const LastThreeCard=(props)=>{
  ...
  const handleSubmit=async(e)=>{
    ...
    >
      {close => (
        <ModalContainer>
          <ModalDesc>Are you sure you want to Delete?</ModalDesc>
          <ModalDesc>This transaction will be deleted immediately. You can’t undo this action.</ModalDesc>
          <ButtonsContainer>
            <CloseButton
              type="button"
            ...
            <ConfirmButton type="button" onClick={deleteItem}>
            Yes, Delete
            </ConfirmButton>
